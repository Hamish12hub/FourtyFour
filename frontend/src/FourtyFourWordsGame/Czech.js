...
import theFlag from '../photos/flags/Czechia.png';
...
function Czech() {
  ...
  const TheLanguage = "Czech"

       const [score, setScore] = useState(-1);
    const [myOtherLanguage, setMyOtherLanguage] = useState([
//1-10
"Ahoj", "Nazdar", "Dekuji", "Prosim", "A", "Ta", "Ano", "Ne", "Dobre rano", "Dobre odpoledne",
//11-21
"Jidlo", "Vejce", "Mleko", "Chleb", "Chipsy", "Ryba", "Cokolada", "Pizza", "Voda", "Pivo", "Vino",
// 22-29
"Restaurace", "Dum", "Plaz", "Trh", "Obchod", "Mesto", "Bazen", "Park", "Toaleta",
//30-35
"Ucet", "Penize", "Telefon", "Vegetarian", "Pas", "Vlak", "Auto",
//36-44
"Jeden", "Dva", "Tri", "Ctyri", "Pet", "Sest", "Sedm", "Osm", "Devet"
  ...
  const navigateBackHome = () => {
    ...
    const newUrl = currentUrl.replace("/czech", "");
  ...
  const UpdatingCACScore = async (e) => {
    const token = localStorage.getItem('token');
    const req = await fetch('http://localhost:1337/UpdatingCzechScore', {
      method: "POST",
