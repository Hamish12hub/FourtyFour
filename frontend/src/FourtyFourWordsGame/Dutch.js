...
import theFlag from '../photos/flags/Netherlands.png';
...
//1-10
"Hallo", "Hoi", "Dank u", "Alstublieft", "En", "De", "Ja", "Nee", "Goedemorgen", "Goedemiddag", 
//11-21
"Eten", "Eieren", "Melk", "Brood", "Chips", "Vis", "Chocolade", "Pizza", "Water", "Bier", "Wijn", 
// 22-29
"Restaurant", "Huis", "Strand", "Winkel", "Stad", "Zwembad", "Park", "Toilet", 
//30-35
"De rekening", "Geld", "Telefoon", "Vegetarisch", "Trein", "Auto", 
//36-44
"Een", "Twee", "Drie", "Vier", "Vijf", "Zes", "Zeven", "Acht", "Negen",
  ...
  const navigateBackHome = () => {
    ...
    const newUrl = currentUrl.replace("/dutch", "");
  ...
  const UpdatingCACScore = async (e) => {
    const token = localStorage.getItem('token');
    const req = await fetch('http://localhost:1337/UpdatingDutchScore', {
      method: "POST",
