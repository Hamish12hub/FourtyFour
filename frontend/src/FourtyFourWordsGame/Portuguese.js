...
import theFlag from '../photos/flags/Portugal.png';
...
function Portuguese() {
  ...
  const TheLanguage = "Portuguese"

       const [score, setScore] = useState(-1);
    const [myOtherLanguage, setMyOtherLanguage] = useState([
//1-10
'Ola', 'Oi', 'Obrigado', 'Por favor', 'E', 'OA', 'Sim', 'Nao', 'Bom dia', 'Boa tarde',
//11-21
'Comida', 'Ovos', 'Leite', 'Pao', 'Batatas fritas', 'Peixe', 'Chocolate', 'Pizza', 'Agua', 'Cerveja', 'Vinho',
// 22-29
'Restaurante', 'Casa', 'Praia', 'Loja', 'Cidade', 'Piscina', 'Parque', 'Banheiro',
//30-35
'A conta', 'Dinheiro', 'Telefone', 'Vegetariano', 'Trem', 'Carro',
//36-44
'Um', 'Dois', 'Tres', 'Quatro', 'Cinco', 'Seis', 'Sete', 'Oito', 'Nove'
  ...
  const navigateBackHome = () => {
    ...
    const newUrl = currentUrl.replace("/Portuguese", "");
  ...
  const UpdatingCACScore = async (e) => {
    const token = localStorage.getItem('token');
    const req = await fetch('http://localhost:1337/UpdatingPortugueseScore', {
      method: "POST",
